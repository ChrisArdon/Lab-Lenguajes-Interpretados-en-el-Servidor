    ...
    <section>
        <article>
            <div id="info">
                <table id="hor-zebra" summary="Datos recibidos del formulario">
                    ...
                    <tbody>
                        ...
                        if (isset($_POST['submit']) && $_POST['submit'] = "Enviar") :
                            ...
                            extract($_POST);
                            $dolares = !empty($money) ? ('$' . $money) : "<a href=\"ingresodatos.html\">No ingresó el valor en dolares.</a>";
                            echo "\t<tr class=\"odd\">\n";
                            echo "\t\t<td>\n$dolares\n</td>";
                            $euros = !empty($money) ? ('€' . round(($money * 0.8238929), 2)) : "<a href=\"ingresodatos.html\">---</a>";
                            echo "\t\t<td>\n $euros \n</td>\n";
                            echo "\t</tr>\n";
                            echo "\t<tr>\n";
                        else :
                ...
                <div id="link">
                    <a href="ingresodatos.html" class="button-link">Ingresar nueva cantidad</a>
                </div>
            </div>
        </article>
    </section>
